      ...
      <section className="mx-auto max-w-6xl px-6 pt-28 md:pt-32">
        <div className="flex flex-col gap-8 text-center md:gap-12">
          ...
          <div className="flex items-center justify-center gap-4">
            <a
              href="https://instagram.com/ejproperties"
              target="_blank"
                ...
                <div className="p-4">
                  ...
                  {post.permalink && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-2 inline-block text-xs uppercase tracking-[0.2em] text-muted-foreground transition hover:text-foreground"
                    >
                      View on Instagram →
                    </a>
                  )}
